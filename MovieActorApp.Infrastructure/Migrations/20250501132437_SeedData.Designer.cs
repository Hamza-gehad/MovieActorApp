...
namespace MovieActorApp.Migrations
{
    ...
    [Migration("20250501132437_SeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieActorApp.Domain.Models.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieActorApp.Domain.Models.Movie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ActorMovies", b =>
                {
                    b.HasOne("MovieActorApp.Domain.Models.Actor", null)
                        .WithMany()
                        .HasForeignKey("ActorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieActorApp.Domain.Models.Movie", null)
                        .WithMany()
